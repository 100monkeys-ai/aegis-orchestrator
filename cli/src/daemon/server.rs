    ...
    */
    ...
    tokio::spawn({
        ...
        async move {
            ...
            let zaru_free = SecurityContext {
                name: "zaru-free".to_string(),
                description:
                    "Public free tier — curated tools, rate-limited, ephemeral storage only."
                        .to_string(),
                capabilities: vec![
                    // Read-only filesystem with /workspace restriction
                    Capability {
                    ...
                    Capability {
                        tool_pattern: "fs.list".to_string(),
                        path_allowlist: Some(vec![PathBuf::from("/workspace")]),
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    Capability {
                        tool_pattern: "fs.grep".to_string(),
                        path_allowlist: Some(vec![PathBuf::from("/workspace")]),
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    Capability {
                        tool_pattern: "fs.glob".to_string(),
                        path_allowlist: Some(vec![PathBuf::from("/workspace")]),
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    // Web access
                    Capability {
                        tool_pattern: "web.search".to_string(),
                        path_allowlist: None,
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    Capability {
                        tool_pattern: "web.fetch".to_string(),
                        path_allowlist: None,
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    // Task management
                    Capability {
                        tool_pattern: "aegis.task.execute".to_string(),
                        path_allowlist: None,
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    Capability {
                        tool_pattern: "aegis.task.status".to_string(),
                        path_allowlist: None,
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    Capability {
                        tool_pattern: "aegis.task.list".to_string(),
                        path_allowlist: None,
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    Capability {
                        tool_pattern: "aegis.task.logs".to_string(),
                        path_allowlist: None,
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    Capability {
                        tool_pattern: "aegis.workflow.list".to_string(),
                        path_allowlist: None,
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    Capability {
                        tool_pattern: "aegis.workflow.run".to_string(),
                        path_allowlist: None,
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
                    ...
                    Capability {
                        tool_pattern: "aegis.system.info".to_string(),
                        path_allowlist: None,
                        command_allowlist: None,
                        subcommand_allowlist: None,
                        domain_allowlist: None,
            ...
            let zaru_pro = SecurityContext {
                name: "zaru-pro".to_string(),
                description: "Paid individual tier — full tool access, persistent storage."
                    .to_string(),
            ...
            let zaru_business = SecurityContext {
                name: "zaru-business".to_string(),
                description:
                    "Team/org tier — full tool access, persistent storage, 90-day audit retention."
                        .to_string(),
                capabilities: vec![Capability {
                    tool_pattern: "*".to_string(),
                    path_allowlist: None,
            ...
            let zaru_enterprise = SecurityContext {
                name: "zaru-enterprise".to_string(),
                description: "Enterprise tier — full tool access, persistent storage, 365-day audit retention.".to_string(),
                capabilities: vec![Capability {
                    tool_pattern: "*".to_string(),
                    path_allowlist: None,
                    command_allowlist: None,
            ...
            let _ = sec_repo.save(zaru_free).await;
            let _ = sec_repo.save(zaru_pro).await;
            let _ = sec_repo.save(zaru_business).await;
            let _ = sec_repo.save(zaru_enterprise).await;
        }
    });
